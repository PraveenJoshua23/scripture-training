 ...
 *
 * The one thing that does not come along is `functions/`: Pages runs those,
 * the APK does not. Anything under `/api` has to be fetched from the deployed
 * site instead, which is what `NEXT_PUBLIC_API_ORIGIN` is for.
 */
